...
export class EventService {
    ...
    private formatCipherId(ev: EventResponse, options: EventOptions) {
        ...
        a.setAttribute(
            "href",
            "#/organizations/" + ev.organizationId + "/vault?search=" + shortId + "&viewEvents=" + ev.cipherId
        );
        return a.outerHTML;
    }
    ...
    private formatProviderUserId(ev: EventResponse) {
        ...
        a.setAttribute(
            "href",
            "#/providers/" + ev.providerId + "/manage/people?search=" + shortId + "&viewEvents=" + ev.providerUserId
        );
        return a.outerHTML;
    }
