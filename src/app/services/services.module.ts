...
export function initFactory(storageService: StorageServiceAbstraction, cryptoService: CryptoServiceAbstraction,
    ...
    authService: AuthService, stateService: StateServiceAbstraction): Function {
    return async () => {
    ...
    providers: [
        ...
        },
        {
            ...
            useFactory: (cryptoService: CryptoServiceAbstraction, userService: UserServiceAbstraction,
                ...
                i18nService: I18nServiceAbstraction, injector: Injector) =>
                new CipherService(cryptoService, userService, settingsService, apiService, fileUploadService,
                    storageService, i18nService, () => injector.get(SearchServiceAbstraction)),
            deps: [
                CryptoServiceAbstraction,
                UserServiceAbstraction,
        ...
        },
        {
            ...
            useFactory: (storageService: StorageServiceAbstraction, secureStorageService: StorageServiceAbstraction,
                ...
                return new CryptoService(storageService, storageImplementation, cryptoFunctionService, platformUtilsService, logService);
            },
            deps: [
                StorageServiceAbstraction,
                'SECURE_STORAGE',
        ...
        { provide: PlatformUtilsServiceAbstraction, useClass: WebPlatformUtilsService },
        {
        ...
        },
        {
            ...
            useFactory: (userService: UserServiceAbstraction, apiService: ApiServiceAbstraction,
                ...
                sendService: SendServiceAbstraction) => new SyncService(userService, apiService, settingsService,
        ...
        },
        {
            ...
            useFactory: (cipherService: CipherServiceAbstraction, folderService: FolderServiceAbstraction,
                ...
                policyService: PolicyServiceAbstraction) => new VaultTimeoutService(cipherService, folderService,
                    collectionService, cryptoService, platformUtilsService, storageService, messagingService, searchService, userService, tokenService,
